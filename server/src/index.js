...
const corsOptions = {
  origin: [
    ...
    'https://servisbeta.com',      // Production domain
    'http://servisbeta.com',       // Allow both http and https
    'https://www.servisbeta.com',  // With www subdomain
    'http://www.servisbeta.com'    // Allow both http and https
  ],
  credentials: true,
